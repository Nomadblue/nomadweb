...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_nomadpost', (
            (u'post_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['nomadblog.Post'], unique=True, primary_key=True)),
    ...
    models = {
        ...
        u'blog.nomadpost': {
            'Meta': {'object_name': 'NomadPost', '_ormbases': [u'nomadblog.Post']},
            u'post_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['nomadblog.Post']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'nomadblog.post': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nomadblog.Category']"}),
